...
for p in sorted(base.iterdir()):
    ...
    uses_data = any(k in s for k in ['06_data.csv','read.csv(&quot;06_data','read.csv("06_data','import(&quot;06_data','import("06_data','rio::import'])
    uses_random = any(k in s for k in ['runif(','sample(','rnorm('])
