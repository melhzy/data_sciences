...
flow_annotations <- list(
  ...
  list(x = 10, y = 8.6, text = "<b>p &lt; 0.05</b>",
    showarrow = FALSE, font = list(size = 16)),
  list(x = 10, y = 8.0, text = "Reject H<sub>0</sub>",
    showarrow = FALSE, font = list(size = 15)),
  list(x = 10, y = 7.4, text = "Support H<sub>1</sub>",
    showarrow = FALSE, font = list(size = 15)),
  list(x = 10, y = 5.5, text = "<b>p ≥ 0.05</b>",
    showarrow = FALSE, font = list(size = 16)),
  list(x = 10, y = 4.9, text = "Fail to Reject H<sub>0</sub>",
    showarrow = FALSE, font = list(size = 15)),
  list(x = 10, y = 4.3, text = "No Support for H<sub>1</sub>",
    showarrow = FALSE, font = list(size = 15)),
