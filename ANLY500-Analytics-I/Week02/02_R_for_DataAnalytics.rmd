...
# Create the flowchart using ggplot2
ggplot() +
  # Collect Data box
  annotate("rect", xmin=0.5, xmax=4.5, ymin=7, ymax=9, 
           fill="lightblue", color="darkblue", linewidth=1.5) +
  annotate("text", x=2.5, y=8, label="Collect Data", 
           size=6, fontface="bold") +
  
  # Calculate p-value box
  annotate("rect", xmin=0.5, xmax=4.5, ymin=4.5, ymax=6.5, 
           fill="lightyellow", color="darkgoldenrod", linewidth=1.5) +
  annotate("text", x=2.5, y=5.9, label="Calculate p-value:", 
           size=5, fontface="bold") +
  annotate("text", x=2.5, y=5.4, label="Probability of data", size=4.5) +
  annotate("text", x=2.5, y=4.9, label="IF H\u2080 is true", 
           size=4.5) +
  
  # Reject box
  annotate("rect", xmin=5.5, xmax=9.5, ymin=6.5, ymax=9, 
           fill="lightgreen", color="darkgreen", linewidth=1.5) +
  annotate("text", x=7.5, y=8.3, label="p < 0.05", 
           size=5.5, fontface="bold") +
  annotate("text", x=7.5, y=7.6, label="Reject H\u2080", 
           size=5) +
  annotate("text", x=7.5, y=6.9, label="Support H\u2081", 
           size=5) +
  
  # Fail to reject box
  annotate("rect", xmin=5.5, xmax=9.5, ymin=3, ymax=5.5, 
           fill="lightcoral", color="darkred", linewidth=1.5) +
  annotate("text", x=7.5, y=4.9, label="p \u2265 0.05", 
           size=5.5, fontface="bold") +
  annotate("text", x=7.5, y=4.2, label="Fail to Reject H\u2080", 
           size=5) +
  annotate("text", x=7.5, y=3.5, label="No Support for H\u2081", 
           size=5) +
  
  # Arrows
  annotate("segment", x=2.5, xend=2.5, y=7, yend=6.5,
           arrow=arrow(length=unit(0.3,"cm"), type="closed"), 
           linewidth=1.2) +
  annotate("segment", x=4.5, xend=5.5, y=5.5, yend=7.75,
           arrow=arrow(length=unit(0.3,"cm"), type="closed"), 
           linewidth=1.2) +
  annotate("segment", x=4.5, xend=5.5, y=5.5, yend=4.25,
           arrow=arrow(length=unit(0.3,"cm"), type="closed"), 
           linewidth=1.2) +
  
  # Title
  labs(title="Hypothesis Testing Logic Flow") +
