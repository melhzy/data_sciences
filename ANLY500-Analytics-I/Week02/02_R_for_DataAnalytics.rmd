...
flow_annotations <- list(
  ...
  list(x = 4, y = 4.7, text = "IF H<sub>0</sub> is true",
    showarrow = FALSE, font = list(size = 14)),
    list(x = 10, y = 8.9, text = "<b>p &lt; 0.05</b>",
    showarrow = FALSE, font = list(size = 16)),
    list(x = 10, y = 8.3, text = "Reject H<sub>0</sub>",
    showarrow = FALSE, font = list(size = 15)),
    list(x = 10, y = 7.7, text = "Support H<sub>1</sub>",
    showarrow = FALSE, font = list(size = 15)),
  list(x = 10, y = 5.5, text = "<b>p ≥ 0.05</b>",
    showarrow = FALSE, font = list(size = 16)),
    list(x = 10, y = 4.95, text = "Fail to Reject H<sub>0</sub>",
    showarrow = FALSE, font = list(size = 15)),
    list(x = 10, y = 4.35, text = "No Support for H<sub>1</sub>",
    showarrow = FALSE, font = list(size = 15)),
