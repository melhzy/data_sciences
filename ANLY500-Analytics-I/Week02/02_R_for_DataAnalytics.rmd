...
flow_annotations <- list(
  ...
  list(x = 10, y = 4.3, text = "No Support for H<sub>1</sub>",
    showarrow = FALSE, font = list(size = 15)),
  list(x = 4, y = 6.3, xref = "x", yref = "y",
    ax = 4, ay = 7.5, axref = "x", ayref = "y",
    arrowhead = 3, arrowsize = 1, arrowwidth = 2,
    arrowcolor = "black", showarrow = TRUE, text = ""),
  list(x = 7.5, y = 8.4, xref = "x", yref = "y",
    ax = 6.4, ay = 6.0, axref = "x", ayref = "y",
    arrowhead = 3, arrowsize = 1, arrowwidth = 2,
    arrowcolor = "black", showarrow = TRUE, text = ""),
  list(x = 7.5, y = 5.4, xref = "x", yref = "y",
    ax = 6.4, ay = 5.2, axref = "x", ayref = "y",
    arrowhead = 3, arrowsize = 1, arrowwidth = 2,
    arrowcolor = "black", showarrow = TRUE, text = "")
)
