...
flow_shapes <- list(
  list(type = "rect", x0 = 1.5, x1 = 6.5, y0 = 7.4, y1 = 9.4,
    fillcolor = "lightblue", line = list(color = "darkblue", width = 4)),
  list(type = "rect", x0 = 1.5, x1 = 6.5, y0 = 4.3, y1 = 6.3,
    fillcolor = "#fff5cc", line = list(color = "#b8860b", width = 4)),
  list(type = "rect", x0 = 7.5, x1 = 12.5, y0 = 7.4, y1 = 9.4,
    fillcolor = "#98fb98", line = list(color = "#006400", width = 4)),
  list(type = "rect", x0 = 7.5, x1 = 12.5, y0 = 4.3, y1 = 6.3,
    fillcolor = "#f4a6a6", line = list(color = "#8b0000", width = 4))
)

flow_annotations <- list(
  list(x = 4, y = 8.4, text = "<b>Collect Data</b>",
    showarrow = FALSE, font = list(size = 18)),
  list(x = 4, y = 5.8, text = "<b>Calculate p-value:</b>",
    showarrow = FALSE, font = list(size = 16)),
  list(x = 4, y = 5.2, text = "Probability of data",
    showarrow = FALSE, font = list(size = 14)),
  list(x = 4, y = 4.7, text = "IF H<sub>0</sub> is true",
    showarrow = FALSE, font = list(size = 14)),
  list(x = 10, y = 8.6, text = "<b>p &lt; 0.05</b>",
    showarrow = FALSE, font = list(size = 16)),
    list(x = 10, y = 8.05, text = "Reject H<sub>0</sub>",
    showarrow = FALSE, font = list(size = 15)),
    list(x = 10, y = 7.55, text = "Support H<sub>1</sub>",
    showarrow = FALSE, font = list(size = 15)),
  list(x = 10, y = 5.5, text = "<b>p ≥ 0.05</b>",
    showarrow = FALSE, font = list(size = 16)),
    list(x = 10, y = 5.0, text = "Fail to Reject H<sub>0</sub>",
    showarrow = FALSE, font = list(size = 15)),
    list(x = 10, y = 4.55, text = "No Support for H<sub>1</sub>",
    showarrow = FALSE, font = list(size = 15)),
    list(x = 4, y = 6.35, xref = "x", yref = "y",
      ax = 4, ay = 7.45, axref = "x", ayref = "y",
    arrowhead = 3, arrowsize = 1, arrowwidth = 2,
    arrowcolor = "black", showarrow = TRUE, text = ""),
    list(x = 7.45, y = 8.4, xref = "x", yref = "y",
      ax = 6.1, ay = 5.9, axref = "x", ayref = "y",
    arrowhead = 3, arrowsize = 1, arrowwidth = 2,
    arrowcolor = "black", showarrow = TRUE, text = ""),
    list(x = 7.45, y = 5.4, xref = "x", yref = "y",
      ax = 6.1, ay = 5.0, axref = "x", ayref = "y",
    arrowhead = 3, arrowsize = 1, arrowwidth = 2,
    arrowcolor = "black", showarrow = TRUE, text = "")
)

flow_fig <- plot_ly(
  x = c(0), y = c(0), type = "scatter", mode = "markers",
  marker = list(opacity = 0)
) %>%
  layout(
    title = list(text = "Hypothesis Testing Logic Flow", x = 0.5, font = list(size = 24)),
    xaxis = list(range = c(0, 14), showgrid = FALSE, zeroline = FALSE,
        showticklabels = FALSE, title = NULL, fixedrange = TRUE),
    yaxis = list(range = c(3.5, 10), showgrid = FALSE, zeroline = FALSE,
        showticklabels = FALSE, title = NULL, fixedrange = TRUE),
    shapes = flow_shapes,
    ...
    paper_bgcolor = "white",
    showlegend = FALSE,
    margin = list(t = 70, r = 20, b = 20, l = 20)
  )
