...
flow_shapes <- list(
  list(type = "rect", x0 = 0.5, x1 = 4.5, y0 = 7, y1 = 9,
    fillcolor = "lightblue", line = list(color = "darkblue", width = 4)),
  list(type = "rect", x0 = 0.5, x1 = 4.5, y0 = 4.5, y1 = 6.5,
    fillcolor = "#fff5cc", line = list(color = "#b8860b", width = 4)),
  list(type = "rect", x0 = 5.5, x1 = 9.5, y0 = 6.5, y1 = 9,
    fillcolor = "#98fb98", line = list(color = "#006400", width = 4)),
  list(type = "rect", x0 = 5.5, x1 = 9.5, y0 = 3, y1 = 5.5,
    fillcolor = "#f4a6a6", line = list(color = "#8b0000", width = 4))
)

flow_annotations <- list(
  list(x = 2.5, y = 8, text = "<b>Collect Data</b>",
    showarrow = FALSE, font = list(size = 18)),
  list(x = 2.5, y = 6.1, text = "<b>Calculate p-value:</b>",
    showarrow = FALSE, font = list(size = 16)),
  list(x = 2.5, y = 5.5, text = "Probability of data",
    showarrow = FALSE, font = list(size = 14)),
  list(x = 2.5, y = 5, text = "IF H<sub>0</sub> is true",
    showarrow = FALSE, font = list(size = 14)),
  list(x = 7.5, y = 8.4, text = "<b>p &lt; 0.05</b>",
    showarrow = FALSE, font = list(size = 16)),
  list(x = 7.5, y = 7.7, text = "Reject H<sub>0</sub>",
    showarrow = FALSE, font = list(size = 15)),
  list(x = 7.5, y = 7, text = "Support H<sub>1</sub>",
    showarrow = FALSE, font = list(size = 15)),
  list(x = 7.5, y = 5.1, text = "<b>p &ge; 0.05</b>",
    showarrow = FALSE, font = list(size = 16)),
  list(x = 7.5, y = 4.4, text = "Fail to Reject H<sub>0</sub>",
    showarrow = FALSE, font = list(size = 15)),
  list(x = 7.5, y = 3.7, text = "No Support for H<sub>1</sub>",
    showarrow = FALSE, font = list(size = 15)),
  list(x = 2.5, y = 7, ax = 2.5, ay = 6.6, arrowhead = 3, arrowsize = 1,
    arrowwidth = 2, arrowcolor = "black", showarrow = TRUE, text = ""),
  list(x = 4.5, y = 5.5, ax = 5.6, ay = 7.8, arrowhead = 3, arrowsize = 1,
    arrowwidth = 2, arrowcolor = "black", showarrow = TRUE, text = ""),
  list(x = 4.5, y = 5.5, ax = 5.6, ay = 4.2, arrowhead = 3, arrowsize = 1,
    arrowwidth = 2, arrowcolor = "black", showarrow = TRUE, text = "")
)
...
flow_fig <- plot_ly(
  ...
  layout(
    ...
    yaxis = list(range = c(2, 10), showgrid = FALSE, zeroline = FALSE,
        showticklabels = FALSE, title = NULL, fixedrange = TRUE),
    shapes = flow_shapes,
