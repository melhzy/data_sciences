...
# Part 5: Hypothesis Testing {.tabset}
...
```{r hypothesis-logic, echo=FALSE, fig.height=4, fig.width=8}
# Visualize hypothesis testing logic
par(mar = c(2, 2, 3, 2))
plot.new()
plot.window(xlim = c(0, 10), ylim = c(0, 10))

# Boxes
rect(0.5, 7, 4.5, 9, col = "lightblue", border = "darkblue", lwd = 2)
text(2.5, 8, "Collect Data", cex = 1.2, font = 2)

rect(0.5, 4.5, 4.5, 6.5, col = "lightyellow", border = "darkgoldenrod", lwd = 2)
text(2.5, 5.5, "Calculate p-value:\nProbability of data\nIF H₀ is true", cex = 1, font = 2)

rect(5.5, 6.5, 9.5, 9, col = "lightgreen", border = "darkgreen", lwd = 2)
text(7.5, 7.75, "p < 0.05\nReject H₀\nSupport H₁", cex = 1.1, font = 2)

rect(5.5, 3, 9.5, 5.5, col = "lightcoral", border = "darkred", lwd = 2)
text(7.5, 4.25, "p ≥ 0.05\nFail to Reject H₀\nNo Support for H₁", cex = 1.1, font = 2)

# Arrows
arrows(2.5, 7, 2.5, 6.5, lwd = 2, length = 0.15)
arrows(4.5, 5.5, 5.5, 7.75, lwd = 2, length = 0.15)
arrows(4.5, 5.5, 5.5, 4.25, lwd = 2, length = 0.15)

title("Hypothesis Testing Logic Flow", cex.main = 1.5, font.main = 2)
```
...
# Part 6: Practical Applications {.tabset}
...
# Part 7: Summary and Best Practices {.tabset}
