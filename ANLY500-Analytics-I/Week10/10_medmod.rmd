...
> **Note:** The Sobel test assumes that the indirect effect (a*b) is normally distributed. This is often *not* true, especially in smaller samples. This makes the Sobel test "conservative" (harder to find significant results).
...
if (!require("MeMoBootR")) devtools::install_github("doomlab/MeMoBootR")
library(MeMoBootR)
...
> 2.  **Multicollinearity:** X and X*Z are highly correlated because X is inside X*Z. Centering breaks this correlation, making the math more stable.
