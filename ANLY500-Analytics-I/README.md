...
This fully online course runs for 7 weeks. Completing three credits in this timeframe requires dedication and effective time management. Your learning will be self-directed with instructor support available via email and Canvas.
...
3. **Exam (30%)**: One final exam completed in RStudio, following the assignment format
4. **Final Project (25%)**: Research project (individual or groups up to 3 people) analyzing a dataset
...
### Week 1: R Learning and Introduction
- Introduction to the course
- Install R and RStudio
- Start coding with R
- **Reading:** Chapter 3

### Week 2: Introduction to Data Analytics & Basic Statistics
- What is data analytics?
- Predictive, descriptive, and prescriptive analytics
- Theories, hypothesis, and data collection
- The research process
- Qualitative vs quantitative data
- Variable identification and measurement
- **Reading:** Chapter 1

### Week 3: Statistics & Data Visualization
...
- ggplot2, histograms, bar charts, line graphs
- **Reading:** Chapters 2, 4

### Week 4: Data Screening
- Accuracy and error
- Handling missing values
- Dealing with outliers
- Additivity, normality, linearity
...
- Final Exam (completed in RStudio)
...
ANLY500-Analytics-I/
├── README.md
├── Week01/          # R Introduction
├── Week02/          # Data Analytics Basics
├── Week03/          # Statistics & Visualization
├── Week04/          # Data Screening
├── Week05/          # Correlation & Regression
├── Week06/          # t-tests & ANOVA
└── Week07/          # Final Exam & Project
```
...
### Deadlines
- Watch deadlines closely - this 7-week course moves quickly!
...
*This is a 7-week intensive online course. Success requires consistent effort, time management, and proactive engagement with course materials and the instructor.*
