...
Finally, we visualize the group differences using a bar chart with error bars.

```{r plot-final, fig.height=4, fig.width=6}
...
ggplot(master, aes(x = dose, y = libido)) +
  cleanup +
  # Bar for Mean
  stat_summary(fun = mean, geom = "bar", fill = "White", color = "Black") +
  # Error bars (Confidence Intervals)
  stat_summary(fun.data = mean_cl_normal, geom = "errorbar", width = .2) +
  labs(x = "Dosage", y = "Libido Score", title = "Effect of Viagra on Libido")
```
