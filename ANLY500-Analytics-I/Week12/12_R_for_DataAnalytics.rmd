...
*   **Linear Trend (L):** `r ifelse(p_linear < 0.05, "Significant", "Not Significant")` ($p = `r round(p_linear, 3)`$). As dose increases, libido increases linearly.
*   **Quadratic Trend (Q):** `r ifelse(p_quad < 0.05, "Significant", "Not Significant")` ($p = `r round(p_quad, 3)`$). There is no curve.
