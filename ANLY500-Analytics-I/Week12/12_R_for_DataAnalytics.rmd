...
If we simply ran multiple t-tests for every pair of groups, we would run into the **Familywise Error Rate** problem. Every test carries a 5% risk of a False Positive (Type I Error). If you run 3 tests, your risk isn't 5% anymore—it's nearly 15%.
