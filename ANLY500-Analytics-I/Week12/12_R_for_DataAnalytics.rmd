...
If we simply ran multiple t-tests for every pair of groups, we would run into the **Familywise Error Rate** problem. Every test carries a `r alpha * 100`% risk of a False Positive (Type I Error, $\alpha = `r alpha`$).
